  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">System Status</span>
        <span className="text-xs font-semibold text-brand-black">All Models Online</span>
      </div>
    </motion.div>
  );
};
